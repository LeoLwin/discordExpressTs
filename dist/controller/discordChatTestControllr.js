...
router.post("/addDiscordData", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const botClient = yield (0, discord_1.logInBot)(botToken, clientId, clientSecret);
        const client = {
...
router.get("/loginBots", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        for (const item of DiscordData) {
            const botClient = yield (0, discord_1.logInBot)(item.botToken, item.cliedId, item.clientSecret); // array of Client instances
